package com.example.loginmiihnn;
...
Lớp cấu hình Java này tạo ra một bộ lọc Servlet được gọi là springSecurityFilterChain, chịu trách nhiệm bảo mật tất cả
(bảo vệ URL ứng dụng, xác nhận username và password, chuyển hướng tới form đăng nhập...) trong ứng dụng.
